...
def process_chips_and_descriptions():
    """Load existing chips and generate embeddings using CLIP"""
    ...
    for img_file in image_files:
        ...
        descriptions.append((os.path.basename(img_file), description_text))  # Store both filename and description
